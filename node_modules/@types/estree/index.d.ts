...
export type Node =
    ...
    ClassBody | Class | PropertyDefinition | MethodDefinition | ModuleDeclaration | ModuleSpecifier |
    Protocol | ProtocolBody | ProtocolDeclaration |
    CompPropDeclaration;
...
export type Statement =
    ...
    ForStatement | ForInStatement | ForOfStatement | Declaration | Requirement;
...
export type Declaration =
      ...
      PropertyDefinition | MethodDefinition | CompPropDeclaration |
      ProtocolDeclaration;

export type Requirement =
      PropertyRequirement | MethodRequirement
...
interface BaseProtocol extends BaseNode {
  body: ProtocolBody;
}

export interface ClassBody extends BaseNode {
  type: "ClassBody";
  body: Array<MethodDefinition | PropertyDefinition | CompPropDeclaration>;
}

export interface ProtocolBody extends BaseNode {
  type: "ProtocolBody";
  body: Array<MethodRequirement | PropertyRequirement>;
}
...
export interface MethodRequirement extends BaseNode {
...
export interface  CompPropDeclaration extends BaseNode {
...
export interface PropertyRequirement extends BaseNode {
...
export interface ProtocolDeclaration extends BaseProtocol, BaseDeclaration {
